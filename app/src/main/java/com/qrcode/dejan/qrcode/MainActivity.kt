package com.qrcode.dejan.qrcode
...
class MainActivity : AppCompatActivity() {
    ...
    fun generateQRCode(){
        val bitmap: Bitmap? = encodeAsBitmap("www.google.com",300,300, context)
    ...
    fun createImageFile(bitmapScaled : Bitmap?){
        ...
        val filepath = Environment.getExternalStorageDirectory().absolutePath + File.separator + "qrcode.png"
        val f = File(filepath)
        f.createNewFile()
